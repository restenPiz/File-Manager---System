...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo1/authentication/layouts/overlay/sign-in.html" action="#">
    <!--begin::Heading-->
    ...
    <!--begin::Separator-->
    <div class="separator separator-content my-14"><span class="w-125px text-gray-500 fw-semibold fs-7">With email</span></div>
    <!--end::Separator-->
    ...
    <div class="fv-row mb-8">
        <label class="form-check form-check-inline">
            ...
            <span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">
                I Accept the <a  class="ms-1 link-primary">Terms</a>
            </span>
        </label>
    </div>
    <!--end::Accept-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/authentication/layouts/overlay/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Dec 2024 19:52:49 GMT -->
</html>
